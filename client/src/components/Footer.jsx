...
function Footer() {
  return (
    <div className="w-full flex md:justify-center justify-between items-center flex-col p-4 gradient-bg-footer">
      <div className="w-full flex sm:flex-row flex-col justify-between items-center p-4">
        <div>
          <img src={logo} alt='logo' className='w-32 flex flex-[0.5] justify-center items-center'/>
        </div>
      ...
      {/* <div className="flex justify-center items-center flex-col mt-5">
        ...
        <p className="text-white text-sm text-center">info@mela.com</p>
      </div> */}
